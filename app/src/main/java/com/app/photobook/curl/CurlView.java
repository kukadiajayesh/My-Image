...
package com.app.photobook.curl;
...
public class CurlView extends GLSurfaceView implements View.OnTouchListener,
    ...
    OnPageCurlListener onPageCurlListener;
    ...
    public void onDrawFrame() {
        ...
        if (currentTime >= mAnimationStartTime + mAnimationDurationTime) {
            ...
            mAnimate = false;
            this.onPageCurlListener.onPageCurlPosition(getCurrentIndex());
            requestRender();
        } else {
        ...
        switch (me.getAction()) {
            ...
            case MotionEvent.ACTION_UP: {
                if (mCurlState == CURL_LEFT || mCurlState == CURL_RIGHT) {
                    ...
                    if (this.onPageCurlListener != null) {
                        this.onPageCurlListener.onPageCurlState(this.mCurlState);
                        break;
                    }
                }
                break;
