...
package com.app.photobook.curl2;
 ...
 * @author harism
 */
public class CurlView2 extends GLSurfaceView implements View.OnTouchListener,
    ...
    OnPageCurlListener onPageCurlListner;

    /**
     * Default constructor.
     */
    public CurlView2(Context ctx) {
        super(ctx);
        init(ctx);
    }
     ...
     * Default constructor.
     */
    public CurlView2(Context ctx, AttributeSet attrs) {
        super(ctx, attrs);
        init(ctx);
    }
     ...
     * Default constructor.
     */
    public CurlView2(Context ctx, AttributeSet attrs, int defStyle) {
        this(ctx, attrs);
    }
    ...
    public void onDrawFrame() {
        ...
        if (currentTime >= mAnimationStartTime + mAnimationDurationTime) {
            ...
            mAnimate = false;
            this.onPageCurlListner.onPageCurlPosition(getCurrentIndex());
            requestRender();
        } else {
        ...
        switch (me.getAction()) {
            ...
            case MotionEvent.ACTION_UP: {
                if (mCurlState == CURL_LEFT || mCurlState == CURL_RIGHT) {
                    ...
                    if (this.onPageCurlListner != null) {
                        this.onPageCurlListner.onPageCurlState(this.mCurlState);
                        break;
                    }
                }
                break;
    ...
    public interface OnPageCurlListener {
        void onPageCurlPosition(int i);

        void onPageCurlState(int i);
    }
    ...
    public void setOnPageCurlListner(OnPageCurlListener onPageCurlListner) {
        this.onPageCurlListner = onPageCurlListner;
    }
